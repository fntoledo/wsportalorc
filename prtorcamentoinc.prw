...
/*/
//-------------------------------------------------------------------
WSRESTFUL PRTORCAMENTOINC DESCRIPTION "Serviço REST de orcamento de venda para o portal de vendas"

WSDATA CCODUSR    As String // Usuário Portal

WSMETHOD POST    DESCRIPTION "Inclusão do orçamento de venda vindo do portal de vendas"         WSSYNTAX "/PRTORCAMENTOINC "
WSMETHOD PUT    DESCRIPTION "Alteração do orçamento de venda vindo do portal de vendas"         WSSYNTAX "/PRTORCAMENTOINC "
...
/*/
//-------------------------------------------------------------------
WSMETHOD POST WSRECEIVE CCODUSR WSSERVICE PRTORCAMENTOINC
...
/*/
//-------------------------------------------------------------------
WSMETHOD PUT WSSERVICE PRTORCAMENTOINC
Local cJSonReq 	 := Self:GetContent() // Pega a string do JSON de requisicao
Local oParseJSON := Nil 
Local cJson      := ''
Local cNumOrc    := ''
